<!DOCTYPE html PUBLIC '-//W3C//DTD XHTML 1.0 Transitional//EN' 'http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd'>
    ...
    <div class='container'>
      ...
      <div class='navbar-collapse collapse' id='navbar-store-list-left'>
          <ul class='nav nav-pills nav-justified' id='display_categories'><li class='active'><a href = 'index.php'>Book Keeping</a></li></ul></div></nav> <!--Display store products-->
      <div id='display_products' style='padding-top: 40px;'>
        <div id='display_products_row' class='row'><div class='col-xs-12 col-sm-6 col-md-3'><a href = 'view_product.php?product_id=42'><img src = 'images/qaupd5182xdownload.png'width='100%' height='250px' alt='...' style='height:250px;' /><h5 class='text-center product_name'>New product</h5></a></div></div>
